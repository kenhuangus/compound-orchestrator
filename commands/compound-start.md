---
name: compound-start
description: Start a compound engineering task with a task brief, plan, and clear agent lanes.
...
6. Stop before implementation if ownership or verification is unclear.
